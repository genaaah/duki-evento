export default function Button() {
  return (
    <div className="group  flex justify-center items-center text-zinc-600 text-sm font-bold fixed bottom-4 right-4 animate-jump z-50">
      <div className="absolute opacity-0 group-hover:opacity-100 group-hover:-translate-y-[150%] -translate-y-[300%] duration-500 group-hover:delay-500 skew-y-[20deg] group-hover:skew-y-0 shadow-md">
        <div className="bg-purple-200 flex items-center gap-1 p-2 rounded-md">
          <svg
            fill="none"
            viewBox="0 0 24 24"
            height="20px"
        ...
        <div className="shadow-md bg-purple-200 absolute bottom-0 translate-y-1/2 left-1/2 translate-x-full rotate-45 p-1"></div>
      ...
      <a
        href="https://www.linkedin.com/in/genaro-levato-7118a7255/"
        target="_blank"
      >
        <div className="shadow-md flex items-center group-hover:gap-2 bg-gradient-to-br from-purple-300 to-purple-600 p-3 rounded-full cursor-pointer duration-300">
          <svg
            fill="none"
            viewBox="0 0 24 24"
            height="20px"
          ...
          <span className="text-[0px] text-gray-200 group-hover:text-sm duration-300">

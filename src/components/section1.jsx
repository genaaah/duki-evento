    ...
    <section>
      <div className="mx-auto max-w-screen-2xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div className="animate-fade-right bg-gradient-to-r from-purple-400 to-purple-800 p-8 md:p-12 lg:px-16 lg:py-24">
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-1 lg:grid-cols-2">
            <img
              ...
              className="animate-fade-up h-40 w-full object-cover sm:h-56 md:h-full"
            />
            ...
            <img
              ...
              className="animate-fade-left h-40 w-full object-cover sm:h-56 md:h-full"
            />
          </div>
        </div>
      </div>
